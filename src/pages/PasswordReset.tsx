...
const PasswordReset: React.FC = () => {
  ...
  // Extract and validate tokens from the hash fragment on page load
  useEffect(() => {
    const validateTokens = async () => {
      try {
        ...
        console.log("Hash params extracted:", { accessToken: !!accessToken, refreshToken: !!refreshToken, type });
        
        if (!accessToken || !refreshToken) {
          toast.error('Invalid reset link', { description: 'No access tokens found in URL.' });
          return;
        }
        ...
        toast.error('Error validating reset tokens', { description: error.message });
      }
    };
      ...
      <div className="max-w-md mx-auto">
        ...
        {tokenValidated ? (
          ...
          <div className="text-center">
            ...
            <p className="text-biblenow-beige">Validating reset link...</p>
          </div>
        )}
      </div>
    </AuthLayout>
